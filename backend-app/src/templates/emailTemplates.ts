...
export const getCompleteProfileTemplate = (userName: string, onboardingUrl: string) => {
  const content = `
...
export const getBankingSetupTemplate = (userName: string, dashboardUrl: string, accountStatus?: string) => {
  const content = `
...
export const getAccountActivatedTemplate = (userName: string, dashboardUrl: string) => {
  const content = `
...
export const getReminderTemplate = (userName: string, actionUrl: string, actionType: string, daysLeft?: number) => {
  const content = `
